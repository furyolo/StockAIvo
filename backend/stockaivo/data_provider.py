...
from typing import Dict, List, Optional, Literal, Union, Any, Tuple, Deque, overload
...
class DataValidator:
    ...
    @staticmethod
    @overload
    def validate_price_data_with_repair(
        df: None,
        period: Optional[str] = None
    ) -> Tuple[bool, None, ValidationResult]:
        ...
    ...
    def validate_price_data_with_repair(
        ...
        period: Optional[str] = None
    ) -> Tuple[bool, Optional[pd.DataFrame], ValidationResult]:
        """
        智能数据验证与修复
        ...
        Args:
            df: 包含价格数据的DataFrame，允许传入None以便统一错误处理
