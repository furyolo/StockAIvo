...
GET /stocks/{ticker}/10min?start_date=2024-01-01&end_date=2024-12-31  # 10分钟线数据（从分钟线聚合）
GET /stocks/{ticker}/minute?start_date=2024-01-01&end_date=2024-12-31  # 分钟线数据
...
### v1.8.0 (2025-07-28) - 代码优化与清理
- 🧹 **小时线功能移除**: 完全删除小时线相关功能，因为已被10分钟线取代
- ⚡ **10分钟线优化**: 修复10分钟线默认日期范围逻辑，确保从分钟线正确聚合
- 🔧 **Pandas兼容性**: 修复pandas FutureWarning，将'T'时间频率更新为'min'
- 📊 **数据库清理**: 删除stock_prices_hourly表及相关索引，简化数据库结构
- 🎯 **代码整洁**: 系统性清理所有小时线相关代码，提升代码可维护性
